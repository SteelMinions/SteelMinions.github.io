...
### Includes.js
The includes.js file will containt the code necessary to import the header and footer components across all pages. This will allow for easier updates to the header and footer, as changes will only need to be made in one place. The includes.js file will be linked in all HTML files to ensure the header and footer are consistent across the website.